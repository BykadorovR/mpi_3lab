...
int main (int argc, const char *argv[]) {
    ...
    if (geom.intersection(s1, s2, hull1, hull2)) cout<<" intersection";
    else {
        bool inter1 = geom.nesting(s1, s2, hull1, hull2);
        bool inter2 = geom.nesting(s2, s1, hull2, hull1);
    	if (inter1 || inter2) cout<<"Nasting"; else cout<<" dont ";
    }
